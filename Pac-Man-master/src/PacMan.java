...
public class PacMan {
    ...
    public void setReqDirection(short dir) { reqDirection = dir; }
    public short getReqDirection() { return reqDirection; }
    public short getDirection() { return direction; }
    public void updateDirection() { direction = reqDirection; }
    public double getxPosition() { return xPosition; }
    public double getyPosition() { return yPosition; }
    public void setxPosition(double x) { xPosition = x; }
    public void setyPosition(double y) { yPosition = y; }
    public int getXloc() { return (int) Math.round(xPosition); }
    public int getYloc() { return (int) Math.round(yPosition); }
